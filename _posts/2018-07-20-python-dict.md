...
Python内置了字典: dict的全称是dictionary,在其他语言里也称map,使用键-值(key-value)存储,具有很快的查找速度.
...
载请注明：[Seven的博客](http://sevenold.github.io) » [点击阅读原文](https://sevenold.github.io/2015/08/python-dict/)